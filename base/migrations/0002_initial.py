...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='rotatingshift',
            name='shift1',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shift1', to='base.employeeshift', verbose_name='Shift 1'),
        ),
        migrations.AddField(
            model_name='rotatingshift',
            name='shift2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='shift2', to='base.employeeshift', verbose_name='Shift 2'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='penaltyaccounts',
            name='employee_id',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='penalty_accounts', to='employee.employee', verbose_name='Employee'),
        ),
        migrations.AddField(
            model_name='penaltyaccounts',
            name='late_early_id',
        ...
        migrations.AddField(
            ...
            name='employee',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='notification_sound', to='employee.employee'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='holidays',
            name='company_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='base.company', verbose_name='Company'),
        ),
        migrations.AddField(
            model_name='holidays',
            name='created_by',
        ...
        migrations.AddField(
            model_name='employeeshiftschedule',
            name='day',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='day_schedule', to='base.employeeshiftday', verbose_name='Shift Day'),
        ),
        migrations.AddField(
            model_name='employeeshiftschedule',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='announcement',
            name='company_id',
            field=models.ManyToManyField(blank=True, related_name='announcement', to='base.company', verbose_name='Company'),
        ),
        migrations.AddField(
            model_name='announcement',
            name='created_by',
        ...
        migrations.AddField(
            model_name='announcement',
            name='job_position',
            field=models.ManyToManyField(blank=True, to='base.jobposition', verbose_name='Job Position'),
        ),
        migrations.AddField(
            model_name='announcement',
            name='modified_by',
