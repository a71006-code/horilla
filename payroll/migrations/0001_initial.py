# Generated by Django 4.2.23 on 2026-01-20 18:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('based_on', models.CharField(blank=True, choices=[('basic_pay', 'Basic Pay'), ('gross_pay', 'Gross Pay'), ('taxable_gross_pay', 'Taxable Gross Pay'), ('net_pay', 'Net Pay'), ('ca_state_tax', 'California State Tax (Method B)')], help_text='If the deduction is not fixed then specifies how the deduction provided', max_length=255, null=True)),
